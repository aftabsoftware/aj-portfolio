    ...
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            ...
            <h3 className="flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo">
                Hi! I&apos;m Aftab Jagirdar
                <img src="./assets/hand-icon.png" alt="" className="w-6 mb-1" />
            </h3>
            <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo">Full-Stack Web Developer based in India.</h1>
            <p className="max-w-2xl mx-auto font-Ovo">
  I am a full-stack developer from India specializing in WordPress development, custom themes, plugins, and scalable web solutions. I also build modern applications using React and other frontend technologies.
</p>
